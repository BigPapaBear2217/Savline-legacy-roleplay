stock PreloadAnimations(playerid, id)
{
    if(id == 1) {
        for(new i = 0; i < 67; i ++) {
        ...
        for(new i = 67; i < sizeof(PreloadLibs); i ++) {
            ApplyAnimation(playerid, PreloadLibs[i], "null", 4.0, 0, 0, 0, 0, 0, 1);
        }
    }
    return 1;
...
stock ApplyAnimationEx(playerid, animlib[32], animname[32], Float:fDelta, loop, lockx, locky, freeze, time, forcesync = 1) // ReWrap
{

    if(IsPlayerInAnyVehicle(playerid)) return SendClientMessage(playerid, COLOR_ERROR, "You cannot use animations inside a vehicle.");
    //if( dsys_info[ playerid ][ ds_b_w ] ) return SendErrorMessage( playerid, "You cannot use animations while knocked" );
...
{
    SendClientMessage(playerid, COLOR_BLUE, "_____________________________________________ANIMATIONS____________________________________________");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /dance[1-4], /handsup, /lean [1-3], /injured [1-2], /sit [1-6], /stand [1-14], /drunk, /crack [1-2], /cpr, /hide, /chill");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /rap [1-3], /wank [1-2], /strip [1-7], /bj [1-4], /cellin, /cellout, /piss, /follow, /greet, /hitch, /carry [1-8]");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /bitchslap, /gsign [1-5], /gift [1-2], /getup, /slapped, /slapass, /celebrate [1-2], /win [1-2], /yes, /deal [1-2]");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /invite[1-2], /thankyou, /scratch, /bombplant, /getarrested, /laugh, /lookout, /robman, /crossarms[1-3], /gateopenanim ");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /lay [1-4], /vomit, /eatanim [1-7], /wave, /smoke [1-2], /chat, /fucku, /taichi, /relax, /bat [1-5], /nod, /cry [1-2]");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /chant, /carsmoke, /aimanim [1-6], /gang [1-7], /bed [1-4], /stretch, /angry, /kiss [1-7], /exhausted, /ghand [1-5]");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /basket [1-6], /akick, /box, /cockgun, /bar [1-4], /liftup, /putdown, /dead [1-2], /joint, /benddown, /checkout");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /face [1-8], /scared, /fall [1-4], /think, /shot[1-5], /gas, /asex [1-8], /spin [1-2], /ring, /crawl, /what [1-2]");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /hide, /chill [1-3], /scared [1-7], /roll [1-4], /gunkick, /reload [1-7], /riot [1-7], /deejay [1-6], /cop [1-18]");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /console [1-3], /dancer [1-13], /parkour, /beach [1-18], /bombs [1-7], /camera [1-12], /fixcar [1-2], /dropflag");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /casinoanim [1-24], /clothesanim [1-13], /dodge, /walk [1-15], /fwalk [1-7], /gym [1-29], /no [1-3], /counteranim" );
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /lookaround [1-2], /point [1-3], /panicanim [1-5], /shoutanim [1-3], /argue [1-4], /comeon [1-3], /shakehead, /gro,");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /idles [1-5], /windowanim [1-2], /hiker [1-2], /push [1-3],  /parksit [1-9], /hairanim [1-13], /serve [1-4]");
    SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /facepalm, /basket [1-6], /cribanim [1-11], /catchbox");
    SendClientMessage(playerid, COLOR_BLUE, "__________________________________________________________________________________________________");
    return 1;
}

CMD:sa(playerid, param[])
{
...
CMD:dance(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /dance [1-4]");
    }
    return 1;
}
...
CMD:lean(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /lean [1-3]");
    }
    return 1;
}
...
CMD:injured(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /injured [1-3]");
    }
    return 1;
}
...
CMD:sit(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /sit [1-2]");
    }
    return 1;
}
...
/*CMD:carsit(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /carsit [1-3]");
    }
    return 1;
}*/
...
CMD:stand(playerid, params[])
{
    ...
    {
        case 1:
            ApplyAnimationEx(playerid, "PED", "car_hookertalk", 4.0999, 0, 0, 0, 1, 0, 0);
        case 2:
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /stand [1-12]");
    }
    return 1;
}
...
CMD:walk(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /walk [1-11]");
    }
    return 1;
}
...
CMD:fwalk(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /fwalk [1-7]");
    }
    return 1;
}
...
CMD:crack(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /crack [1-9]");
    }
    return 1;
}
...
CMD:rap(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /rap [1-3]");
    }
    return 1;
}
...
CMD:wank(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /wank [1-2]");
    }
    return 1;
}
...
CMD:strip(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /strip [1-19]");
    }
    return 1;
}
...
CMD:bj(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /bj [1-4]");
    }
    return 1;
}
...
CMD:gsign(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /gsign [1-5]");
    }
    return 1;
}
...
CMD:celebrate(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /celebrate [1-2]");
    }
    return 1;
}
...
CMD:win(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /win [1-2]");
    }
    return 1;
}
...
CMD:deal(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /deal [1-2]");
    }
    return 1;
}
...
CMD:invite(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /invite [1-2]");
    }
    return 1;
}
...
CMD:lookout(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /lookout [1-6]");
    }
    return 1;
}
...
CMD:crossarms(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /crossarms [1-3]");
    }
    return 1;
}
...
CMD:lay(playerid, params[])
{
    switch(strval(params))
    {
        ...
        case 4:
            ApplyAnimationEx(playerid,"BEACH","PARKSIT_W_LOOP", 4.0, 1, 0, 0, 0, 0);
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /lay [1-4]");
    }
    return 1;
}
...
CMD:eatanim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /eatanim [1-7]");
    }
    return 1;
}
...
CMD:wave(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /wave [1-4]");
    }
    return 1;
}
...
CMD:smoke(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /smoke [1-12]");
    }
    return 1;
}
...
CMD:chat(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /chat [1-7]");
    }
    return 1;
}
...
CMD:bat(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /bat [1-5]");
    }
    return 1;
}
...
CMD:cry(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /cry [1-2]");
    }
    return 1;
}
...
CMD:aimanim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /aimanim [1-6]");
    }
    return 1;
}
...
CMD:gang(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /gang [1-7]");
    }
    return 1;
}
...
CMD:bed(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /bed [1-4]");
    }
    return 1;
}
...
CMD:kiss(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /kiss [1-7]");
    }
    return 1;
}
...
CMD:ghand(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /ghand [1-5]");
    }
    return 1;
}
...
CMD:basket(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /basket [1-6]");
    }
    return 1;
}
...
CMD:box(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /box [1-3]");
    }
    return 1;
}
...
CMD:bar(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /bar [1-12]");
    }
    return 1;
}
...
CMD:dead(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /dead [1-2]");
    }
    return 1;
}
...
CMD:carry(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /carry [1-8]");
    }
    return 1;
}
...
CMD:what(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /what [1-2]");
    }
    return 1;
}
...
CMD:chill(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /chill [1-3]");
    }
    return 1;
}
...
CMD:face(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /face [1-8]");
    }
    return 1;
}
...
CMD:scared(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /scared [1-7]");
    }
    return 1;
}
...
CMD:roll(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /roll [1-4]");
    }
    return 1;
}
...
CMD:fall(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /fall [1-2]");
    }
    return 1;
}
...
CMD:shot(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /shot [1-5]");
    }
    return 1;
}
...
CMD:spin(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /spin [1-2]");
    }
    return 1;
}
...
CMD:asex(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /asex [1-8]");
    }
    return 1;
}
...
CMD:reload(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /reload [1-7]");
    }
    return 1;
}
...
CMD:riot(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /riot [1-7]");
    }
    return 1;
}
...
CMD:deejay(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /deejay [1-6]");
    }
    return 1;
}
...
CMD:cop(playerid, params[])
{
    switch(strval(params))
    {
        ...
        case 8:
            ApplyAnimationEx(playerid, "POLICE", "CopTraf_Away", 4.0999, 0, 0, 0, 0, 0, 0);
        case 9:
            ApplyAnimationEx(playerid, "POLICE", "CopTraf_Come", 4.0999, 0, 0, 0, 0, 0, 0);
        case 10:
            ApplyAnimationEx(playerid, "POLICE", "CopTraf_Left", 4.0999, 0, 0, 0, 0, 0, 0);
        case 11:
            ApplyAnimationEx(playerid, "POLICE", "CopTraf_Stop", 4.0999, 0, 0, 0, 0, 0, 0);
        case 12:
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /cop [1-18]");
    }
    return 1;
}
...
CMD:console(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /console [1-3]");
    }
    return 1;
}
...
CMD:dancer(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /dancer [1-13]");
    }
    return 1;
}
...
CMD:parkour(playerid, params[])
{
    ...
    /*switch(strval(params))
    {
        case 1:
            ApplyAnimationEx(playerid, "DAM_JUMP", "DAM_Dive_Loop", 4.0999, 1, 1, 1, 0, 0, 0);
        case 2:
            ApplyAnimationEx(playerid, "DAM_JUMP", "DAM_Launch", 4.0999, 0, 0, 0, 1, 1, 0);
        case 3:
        {
            ApplyAnimationEx(playerid, "DAM_JUMP", "Jump_Roll", 4.0999, 0, 0, 0, 1, 1, 0);
        }
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /parkour [1-3]");
    }*/
    return 1;
}
...
CMD:beach(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /beach [1-18]");
    }
    return 1;
}
...
CMD:bombs(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /bombs [1-7]");
    }
    return 1;
}
...
CMD:camera(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /camera [1-12]");
    }
    return 1;
}
...
CMD:fixcar(playerid, params[])
{
    switch(strval(params)) 
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /fixcar [1-2]");
    }
    return 1;
}
...
/*CMD:caranim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /caranim [1-19]");
    }
    return 1;
}
...
CMD:casinoanim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /casinoanim [1-24]");
    }
    return 1;
}
...
CMD:clothesanim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /clothesanim [1-13]");
    }
    return 1;
}
...
CMD:gym(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /gym [1-29]");
    }
    return 1;
}
...
CMD:no(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /no [1-3]");
    }
    return 1;
}
...
CMD:lookaround(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /lookaround [1-2]");
    }
    return 1;
}
...
CMD:point(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /point [1-3]");
    }
    return 1;
}
...
CMD:panicanim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        case 5:
            ApplyAnimationEx(playerid, "ON_LOOKERS", "panic_cower", 4.0999, 0, 1, 1, 1, 0, 0);
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /panicanim [1-5]");
    }
    return 1;
}
...
CMD:shoutanim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /shoutanim [1-3]");
    }
    return 1;
}
...
CMD:giftanim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /gift [1-2]");
    }
    return 1;
}
...
CMD:argue(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /argue [1-4]");
    }
    return 1;
}
...
CMD:comeon(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /comeon [1-3]");
    }
    return 1;
}
...
CMD:serve(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /serve [1-4]");
    }
    return 1;
}
...
CMD:idles(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /idles [1-5]");
    }
    return 1;
}
...
CMD:windowanim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /windowanim [1-2]");
    }
    return 1;
}
...
CMD:hiker(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /hiker [1-2]");
    }
    return 1;
}
...
CMD:push(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /push [1-3]");
    }
    return 1;
}
...
CMD:parksit(playerid, params[])
{
    switch(strval(params))
    {
        ...
        case 9:
            ApplyAnimationEx(playerid, "SUNBATHE", "SitnWait_in_W", 4.0999, 0, 1, 1, 1, 0, 0);
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /parksit [1-9]");
    }
    return 1;
}
...
CMD:hairanim(playerid, params[])
{
    switch(strval(params)) {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /hairanim [1-13]");
    }
    return 1;
}
...
CMD:cribanim(playerid, params[])
{
    switch(strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_ERROR, "Correct usage: /cribanim [1-11]");
    }
    return 1;
}
